...
# Try flux2-vae instead
vae_v = g.node('VAELoaderKJ', vae_name='flux2-vae.safetensors', device='main_device', weight_dtype='bf16')
...
g.node('SaveImage', images=decoded_v, filename_prefix='ltx_flux2v')
